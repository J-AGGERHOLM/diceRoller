...
<style>
  ...
  .edit-btn:hover { background-color: #3a3a6a; }
  ...
  .hp { background-color: #7f1d1d; }
  .ac { background-color: #1e3a5f; }
  ...
  .save-row:nth-child(odd) { background-color: #1a1a30; }

  .save-name { flex: 1; color: #ccc; }
